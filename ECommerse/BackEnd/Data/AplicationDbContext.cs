    ...
    public class AplicationDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Product>().HasData(
                ...
                new Product { proID = 17, proName = "Product Name 4", proDescription = "Product Desscription", proPrice = 50.00, Image = "p5.webp", CategoryId = 1 },
                new Product { proID = 18, proName = "Product Name 1", proDescription = "Product Desscription", proPrice = 50.00, Image = "p1.webp", CategoryId = 1 },
                new Product { proID = 19, proName = "Product Name 2", proDescription = "Product Desscription", proPrice = 50.00, Image = "p3.webp", CategoryId = 1 },
                new Product { proID = 20, proName = "Product Name 3", proDescription = "Product Desscription", proPrice = 50.00, Image = "p4.webp", CategoryId = 1 },
                new Product { proID = 21, proName = "Product Name 4", proDescription = "Product Desscription", proPrice = 50.00, Image = "p5.webp", CategoryId = 1 },
                new Product { proID = 22, proName = "Product Name 1", proDescription = "Product Desscription", proPrice = 50.00, Image = "p1.webp", CategoryId = 1 },
                new Product { proID = 23, proName = "Product Name 2", proDescription = "Product Desscription", proPrice = 50.00, Image = "p3.webp", CategoryId = 1 },
                new Product { proID = 24, proName = "Product Name 3", proDescription = "Product Desscription", proPrice = 50.00, Image = "p4.webp", CategoryId = 1 },
                new Product { proID = 25, proName = "Product Name 4", proDescription = "Product Desscription", proPrice = 50.00, Image = "p5.webp", CategoryId = 1 },
                //
