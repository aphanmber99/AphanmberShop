...
namespace BackEnd.Test
{
    public class SqliteInMemoryFixture : IDisposable
    {
        ...
        public virtual AplicationDbContext Context
            => ServiceProvider.GetRequiredService<AplicationDbContext>();
        ...
        public virtual IServiceCollection ConfigureServices(IServiceCollection services)
            => services
                .AddDbContext<AplicationDbContext>(b => b.UseSqlite(_connection));
    }
}